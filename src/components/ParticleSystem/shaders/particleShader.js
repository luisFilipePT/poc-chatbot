export const particleVertexShader = `
    ...
    uniform bool uUseGPUPositions;
    
    void main() {
        vec3 pos;
        
        if (uUseGPUPositions) {
            // Sample position from GPU texture
            pos = texture2D(uPositionsTexture, textureCoord).xyz;
        } else {
            // Use CPU-computed position
            pos = position;
        }
        ...
        vColor = color; // color is automatically available when vertexColors is true
        vFilled = filled;
